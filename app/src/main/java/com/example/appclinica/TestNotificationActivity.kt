...
import com.example.appclinica.paymantel.RetrofitFactory
import com.example.appclinica.paymantel.controlador.MyCardAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       /* FirebaseService.sharedPref = getSharedPreferences("sharedPref", Context.MODE_PRIVATE)
        ...
        button.setOnClickListener {
            ...
            Paymentez.addCard(this, Constants.USER_ID, Constants.USER_EMAIL, cardToSabe, object : TokenCallback {
